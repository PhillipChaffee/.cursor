...
This skill orchestrates; review mechanics live in `.cursor/skills/plan-review/SKILL.md`.
...
Invoke `plan-review` (`.cursor/skills/plan-review/SKILL.md`) in **review-only** and
